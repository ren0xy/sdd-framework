...
import type { PlatformId, TaskStatus } from '../types.js';
import type { VerifyFileSystem } from '../verification/verify-file-system.js';
import type { VerificationCheck, VerificationData } from '../verification/verification-data.js';
import { buildVerificationData, mergeChecks } from '../verification/verification-data.js';
...
import { successResult, errorResult, type CommandResult } from './command-result.js';
